...
#define DMA_IN_BUF_SIZE 0x18000000 // 384 MB
#define DMA_OUT_BUF_SIZE 0x1000000 // 16 MB
#define CMA_BUF_TOTAL_SIZE (DMA_IN_BUF_SIZE + DMA_OUT_BUF_SIZE) // 400 MB
#define DMA_INP_SIZE 0x800000
#define DMA_WGT_SIZE (DMA_IN_BUF_SIZE - DMA_INP_SIZE) // 384 MB - 8 MB = 376 MB
#else
...
// MMIO Registers
#define HWC_Monitor_Count 8
#define CTRL_Reg_Count 11
